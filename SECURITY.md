...
opened and closed, and each ticket's title and its created, In Progress, resolved and
due dates as the tracker holds them. That is a history of which services carried exploitable
